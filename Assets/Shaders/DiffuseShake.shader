...
OUT_Data_Vert vert(appdata_t in_v)
{
    ...
    float _tmp_dvx_519 = max(((1.055 * pow(max(res_23, float3(0, 0, 0)), float3(0.4166667, 0.4166667, 0.4166667))) - 0.055), float3(0, 0, 0));
    res_23 = float3(_tmp_dvx_519, _tmp_dvx_519, _tmp_dvx_519);
    tmpvar_2 = res_23;
