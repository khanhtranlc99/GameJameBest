...
using SRF.Service;
using UnityEngine;
//using ZombiePitch.Scripts.Gameplay.Region;
...
public partial class SROptions
{
   ...
   // private CURRENCY_TYPE _type;
    ...
    {
       // DataManager.instance.userProfile.AddCurrency(_type,amount);
    }
    [Category("Booss")]
    [DisplayName("Add Boss")]
    [Sort(1)]
    public void AddBoss()
    {
        // var bigboy = GameObject.FindObjectOfType<BigBossSpawnManager>();
        // if (bigboy != null)
        // {
        //     bigboy.AddTestBigBoy();
        // }
    }
