...
public class ConfigBuild
{
    ...
    private static string KeyStorePath = "Assets/01_ROPE/KeyStore/ropeavatar.keystore";
    ...
    {
        string localPath = "Assets/00_BaseCode/Scenes/HomeScene.unity";
        EditorSceneManager.SaveCurrentModifiedScenesIfUserWantsTo();
        EditorSceneManager.OpenScene(localPath);
    }
    ...
    {
        string localPath = "Assets/00_BaseCode/Scenes/CreatLevel.unity";
        EditorSceneManager.SaveCurrentModifiedScenesIfUserWantsTo();
        EditorSceneManager.OpenScene(localPath);
    }
    ...
    {
        string localPath = "Assets/00_BaseCode/Scenes/TestLevel.unity";
        EditorSceneManager.SaveCurrentModifiedScenesIfUserWantsTo();
        EditorSceneManager.OpenScene(localPath);
    }
